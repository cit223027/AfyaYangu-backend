...
import SpeakDiv from "@/pages/components/speech/SpeakDiv.tsx";
import SpeakParagraph from "@/pages/components/speech/SpeakParagraph.tsx";
import SpeakDivHeading from "@/pages/components/speech/SpeakDivHeading.tsx";
                        ...
                        <BreadcrumbList>
                            <BreadcrumbItem>
                                <BreadcrumbLink asChild>
                                    <Link to="/">{LanguageTranslations.pageHome.english}</Link>
                                </BreadcrumbLink>
                            </BreadcrumbItem>
