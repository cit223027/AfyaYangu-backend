...
import {AfyaYanguMentalHealthArticles} from "@/pages/components/article/AfyaYanguArticles.tsx";
import {
    Breadcrumb,
    BreadcrumbItem,
    BreadcrumbLink,
...
export default function KnowledgeMentalHealthPage() {
        ...
        <div className="w-full">
            <Breadcrumb className="mb-2 flex flex-row items-center">
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbPage>
                            <h4 className="andika-bold text-xl pb-1">{LanguageTranslations.knowledgeMentalHeath.getTranslation(appLanguage)}</h4>
                        </BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>

            <p>{LanguageTranslations.knowledgeMentalHealthDescription.getTranslation(appLanguage)}</p>

            <SearchArticleSection articles={AfyaYanguMentalHealthArticles}/>
        </div>
    )
}
